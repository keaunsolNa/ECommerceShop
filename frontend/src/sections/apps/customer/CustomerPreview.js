            ...
            <List sx={{ width: 1, p: 0 }}>
                ...
                secondaryAction={
                  <Stack direction='row' alignItems='center' justifyContent='center' spacing={0}>
                    <Tooltip title='Export'>
                      <PDFDownloadLink document={<ListCard customer={customer} />}
              ...
              >
                <ListItemAvatar sx={{ mr: 0.75 }}>
                  <Avatar alt={customer.fatherName} size='lg'
                  ...
                  <Grid container spacing={2.25}>
                    <Grid item xs={12}>
                      <MainCard title='About me'>
                        <Typography>
                          Hello, Myself {customer.fatherName}, I’m {customer.role} in international
                          company, {customer.about}
                        </Typography>
                      </MainCard>
                    </Grid>
                    <Grid item xs={12}>
                            ...
                            <Grid container spacing={matchDownMD ? 0.5 : 3}>
                              ...
                              <Grid item xs={12} md={6}>
                                <Stack spacing={0.5}>
                                  ...
                                  <Typography>
                                    Perform task related to project manager with the 100+ team under my observation.
