        ...
        <Container disableGutters={matchDownMd}>
          <Toolbar sx={{ px: { xs: 1.5, md: 0, lg: 0 }, py: 2 }}>
            ...
            <Stack
              ...
              spacing={2}
            >
              <Link className='header-link' color='white' component={RouterLink} to='/login' target='_blank'
                    underline='none'>
                Dashboard
              </Link>
              <Link
              ...
              <Link className='header-link' color='white' href='https://links.codedthemes.com/BQFrl' target='_blank'
                    underline='none'>
                Documentation
              </Link>
              <Box sx={{ display: 'inline-block' }}>
                <AnimateButton>
                  <Button component={Link} href='https://links.codedthemes.com/Aprwb' disableElevation color='primary'
                          variant='contained'>
                    Purchase Now
                  </Button>
                </AnimateButton>
            ...
            >
              ...
              <Stack direction='row' spacing={2}>
                ...
                >
                  <MenuOutlined
                    style={{ color: theme.palette.mode === ThemeMode.DARK ? 'inherit' : theme.palette.grey[100] }} />
                </IconButton>
              </Stack>
              <Drawer
                anchor='top'
                  ...
                  <List>
                    ...
                    <Link style={{ textDecoration: 'none' }} href='https://links.codedthemes.com/sTUAK' target='_blank'>
                      <ListItemButton component='span'>
                        ...
                        <ListItemText primary='Free Version'
                                      primaryTypographyProps={{ variant: 'h6', color: 'text.primary' }} />
                      </ListItemButton>
                    </Link>
